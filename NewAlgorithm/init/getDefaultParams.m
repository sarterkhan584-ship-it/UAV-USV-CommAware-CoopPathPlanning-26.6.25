function params = getDefaultParams()
    ...
    % ---------- 最大熵-信息素联合覆盖搜索参数 ----------
    params.entropyAlpha = log(2);
    params.lambdaCMin = 0.55;
    params.lambdaCMax = 1.45;
    params.lambdaHMin = 0.15;
    params.lambdaHMax = 1.40;
    params.lambdaAMin = 0.12;
    params.lambdaAMax = 0.85;
    params.lambdaRMin = 0.45;
    params.lambdaRMax = 2.10;
    params.lambdaFMin = 0.05;
    params.lambdaFMax = 0.95;
    params.dynamicWeightPower = 1.6;
    params.attractEvap = 0.035;
    params.repulseEvap = 0.055;
    params.attractDeposit = 0.030;
    params.repulseDeposit = 0.40;
    params.pheromoneDiffuse = 0.10;
    params.visitPenaltyPower = 1.25;
    params.frontierRadiusKm = 0.35;
