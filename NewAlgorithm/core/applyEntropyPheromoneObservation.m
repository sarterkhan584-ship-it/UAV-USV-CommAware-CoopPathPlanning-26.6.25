function [state, localMap, stat, observedMaskGlobal] = applyEntropyPheromoneObservation(pos0, pos1, state, localMap, islandMask, params, platformType)
% applyEntropyPheromoneObservation 执行条带探测，并同步更新覆盖、探测次数与熵场。
