function [state, history, stopInfo, viz] = runMaxEntropySimulation(state, history, islandMask, seaMask, xGrid, yGrid, params, viz)
% runMaxEntropySimulation  最大熵算法主循环（无信息素/前沿，仅熵场+动态权重+固定通信权重）。
